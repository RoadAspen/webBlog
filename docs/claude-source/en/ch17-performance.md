...
`
 ...
 Tool Result Budgeting
    ...
    Limit  Value  Purpose      Per-tool characters  50,000  Results persisted to disk when exceeded    Per-tool tokens  100,000  ~400KB text upper bound    Per-message aggregate  200,000 chars  Prevents N parallel tools from blowing the budget in one turn
